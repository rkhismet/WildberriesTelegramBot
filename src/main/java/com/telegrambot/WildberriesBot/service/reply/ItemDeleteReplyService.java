...
public class ItemDeleteReplyService implements Reply {
    ...
    public SendMessage sendMessage(Message message) {
        ...
        try {
            ...
            return messageService.sendWarningMessage(chatId, "reply.item.action.delete.badRequest");
        }
        ...
        if (itemSubscriptionOptional.isEmpty()) {
            return messageService.sendWarningMessage(chatId, "reply.item.action.delete.userError");
        }
        ...
        return messageService.sendSuccessMessage(chatId, "reply.item.action.delete.success");
    }
